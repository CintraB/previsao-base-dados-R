...
#Gradient Boosting
str(treino_novo80)
treino_novo80$is_listened <- as.factor(treino_novo80$is_listened)

# gbm classe com formato character
...
mod_gb <- gbm(is_listened ~ ., data = treino_novo80, n.trees = 100, n.minobsinnode = 30, distribution = "bernoulli")
